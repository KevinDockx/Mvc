...
namespace Microsoft.AspNet.Mvc.ModelBinding
{
    ...
    {
        public ModelBindingResult(object model, bool isModelSet) 
            : this(model, null, isModelSet)
        {
        }
        ...
        /// <param name="isModelSet">A value that represents if the model has been set by the <see cref="IModelBinder"/>.</param>
